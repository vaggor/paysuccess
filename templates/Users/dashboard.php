...
<div class="col-md-6 col-xl-3">
<div class="card seo-card">
<!-- <img src="../files/assets/images/widget/seoimg2.jpg" alt="seo bg" class="img-fluid"> -->
<?php echo $this->Html->image('images/widget/seoimg2.jpg',array('alt'=>'Geo bg','class'=>'img-fluid')); ?>
...
<div class="col-md-6 col-xl-3">
<div class="card seo-card">
<!-- <img src="../files/assets/images/widget/seoimg3.jpg" alt="seo bg" class="img-fluid"> -->
<?php echo $this->Html->image('images/widget/seoimg2.jpg',array('alt'=>'Geo bg','class'=>'img-fluid')); ?>
<div class="overlay-bg"></div>
<div class="card-block seo-content">
<h6>Bounce Rate</h6>
...
<img src="../files/assets/images/avatar-3.jpg" class="img-radius " alt="User-Profile-Image">
</div>
...
<img src="../files/assets/images/blog/blog-r-1.jpg" alt="img" class="img-fluid img-100">
<h6 class="m-t-5 m-b-0">Old Scooter</h6>
<p class="text-muted m-b-15"><small>PNG-100KB</small></p>
</div>
<div class="col-auto text-center">
<img src="../files/assets/images/blog/blog-r-2.jpg" alt="img" class="img-fluid img-100">
<h6 class="m-t-5 m-b-0">Wall Art</h6>
<p class="text-muted m-b-15"><small>PNG-150KB</small></p>
</div>
<div class="col-auto text-center">
<img src="../files/assets/images/blog/blog-r-3.jpg" alt="img" class="img-fluid img-100">
<h6 class="m-t-5 m-b-0">Microphone</h6>
<p class="text-muted m-b-15"><small>PNG-150KB</small></p>
</div>
</div>
</li>
...
<h6><span class="label label-success">Task</span>Sarah marked the Pending Review: <span class="text-c-green m-10"> Trash Can Icon Design</span><small class="text-muted">2 hours ago</small></h6>
</li>
<li class="diactive-feed">
<div class="feed-user-img">
<img src="../files/assets/images/avatar-2.jpg" class="img-radius " alt="User-Profile-Image">
</div>
<h6><span class="label label-primary">comment</span> abc posted a task: <span class="text-c-green m-10">Design a new Homepage</span> <small class="text-muted">6 hours ago</small></h6>
<p class="m-b-15 m-t-15 ">hii <b> @everone</b> Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
</li>
<li class="active-feed">
<div class="feed-user-img">
...
<h6><span class="label label-warning">Task</span>Sarah marked : <span class="text-c-green m-10"> do Icon Design</span><small class="text-muted">10 hours ago</small></h6>
</li>
</ul>
</div>
</div>
